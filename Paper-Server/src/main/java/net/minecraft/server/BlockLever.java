...
public class BlockLever extends Block {
    ...
    public void doPhysics(World world, BlockPosition blockposition, IBlockData iblockdata, Block block) {
        if (this.e(world, blockposition, iblockdata) && !a(world, blockposition, ((EnumLeverPosition) iblockdata.get(BlockLever.FACING)).c().opposite())) {
    ...
    public void updateShape(IBlockAccess iblockaccess, BlockPosition blockposition) {
        ...
        switch (SyntheticClass_1.b[((EnumLeverPosition) iblockaccess.getType(blockposition).get(BlockLever.FACING)).ordinal()]) {
        case 1:
    ...
    static class SyntheticClass_1 {
        ...
        static {
            try {
                SyntheticClass_1.c[EnumDirection.EnumAxis.X.ordinal()] = 1;
            } catch (NoSuchFieldError nosuchfielderror) {
                ;
            }

            try {
                SyntheticClass_1.c[EnumDirection.EnumAxis.Z.ordinal()] = 2;
            ...
            try {
                SyntheticClass_1.b[EnumLeverPosition.EAST.ordinal()] = 1;
            } catch (NoSuchFieldError nosuchfielderror2) {
                ;
            }

            try {
                SyntheticClass_1.b[EnumLeverPosition.WEST.ordinal()] = 2;
            } catch (NoSuchFieldError nosuchfielderror3) {
                ;
            }

            try {
                SyntheticClass_1.b[EnumLeverPosition.SOUTH.ordinal()] = 3;
            } catch (NoSuchFieldError nosuchfielderror4) {
                ;
            }

            try {
                SyntheticClass_1.b[EnumLeverPosition.NORTH.ordinal()] = 4;
            } catch (NoSuchFieldError nosuchfielderror5) {
                ;
            }

            try {
                SyntheticClass_1.b[EnumLeverPosition.UP_Z.ordinal()] = 5;
            } catch (NoSuchFieldError nosuchfielderror6) {
                ;
            }

            try {
                SyntheticClass_1.b[EnumLeverPosition.UP_X.ordinal()] = 6;
            } catch (NoSuchFieldError nosuchfielderror7) {
                ;
            }

            try {
                SyntheticClass_1.b[EnumLeverPosition.DOWN_X.ordinal()] = 7;
            } catch (NoSuchFieldError nosuchfielderror8) {
                ;
            }

            try {
                SyntheticClass_1.b[EnumLeverPosition.DOWN_Z.ordinal()] = 8;
    ...
    public static enum EnumLeverPosition implements INamable {
        ...
        public static EnumLeverPosition a(EnumDirection enumdirection, EnumDirection enumdirection1) {
            switch (SyntheticClass_1.a[enumdirection.ordinal()]) {
            case 1:
                switch (SyntheticClass_1.c[enumdirection1.k().ordinal()]) {
                case 1:
