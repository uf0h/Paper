...
public class BlockSkull extends BlockContainer {
    ...
    public void updateShape(IBlockAccess iblockaccess, BlockPosition blockposition) {
        switch (SyntheticClass_1.a[((EnumDirection) iblockaccess.getType(blockposition).get(BlockSkull.FACING)).ordinal()]) {
        case 1:
        default:
            this.a(0.25F, 0.0F, 0.25F, 0.75F, 0.5F, 0.75F);
            break;
    ...
    static class SyntheticClass_1 {
        ...
        static {
            try {
                SyntheticClass_1.a[EnumDirection.UP.ordinal()] = 1;
            ...
            try {
                SyntheticClass_1.a[EnumDirection.WEST.ordinal()] = 4;
            } catch (NoSuchFieldError nosuchfielderror3) {
                ;
            }

            try {
                SyntheticClass_1.a[EnumDirection.EAST.ordinal()] = 5;
