...
public class DataWatcher {
    ...
    private final Map<Integer, WatchableObject> d = dataValues;
	// SportPaper end
    private boolean e;
    ...
    public <T> void a(int i, T t0) {
        ...
        if (integer == -1) { // Spigot
            ...
            WatchableObject datawatcher_watchableobject = new WatchableObject(integer, i, t0); // Spigot
    ...
    public void add(int i, int j) {
        WatchableObject datawatcher_watchableobject = new WatchableObject(j, i, (Object) null);
    ...
    private WatchableObject j(int i) {
        ...
        try {
            datawatcher_watchableobject = (WatchableObject) this.dataValues.get(i); // Spigot
