...
public class NameReferencingFileConverter {
                ...
                ProfileLookupCallback profilelookupcallback = new ProfileLookupCallback() {
                    ...
                    public void onProfileLookupFailed(GameProfile gameprofile, Exception exception) {
                        ...
                        if (!(exception instanceof ProfileNotFoundException)) {
                            throw new FileConversionException("Could not request user " + gameprofile.getName() + " from backend systems", exception, null);
                        }
                    }
                };
            ...
            try {
                ...
                ProfileLookupCallback profilelookupcallback = new ProfileLookupCallback() {
                    public void onProfileLookupSucceeded(GameProfile gameprofile) {
                        ...
                        if (uuid == null) {
                            throw new FileConversionException("Missing UUID for user profile " + gameprofile.getName(), null);
                        } else {
                    ...
                    private void a(File file, String s, String s1) {
                        ...
                        if (!file1.renameTo(file3)) {
                            throw new FileConversionException("Could not convert file for " + s, null);
                        }
                    }
                    ...
                    private String a(GameProfile gameprofile) {
                        ...
                        if (s == null) {
                            throw new FileConversionException("Could not find the filename for " + gameprofile.getName() + " anymore", null);
                        } else {
                            return s;
                        }
                    }
    ...
    private static void b(File file) {
        if (file.exists()) {
            if (!file.isDirectory()) {
                throw new FileConversionException("Can\'t create directory " + file.getName() + " in world save directory.", null);
            }
        } else if (!file.mkdirs()) {
            throw new FileConversionException("Can\'t create directory " + file.getName() + " in world save directory.", null);
        }
