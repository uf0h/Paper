...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    public void handle(Packet packet) {
        if (this.g()) {
            ...
            try {
                this.i.add(new QueuedPacket(packet, (GenericFutureListener[]) null));
            } finally {
    ...
    public void a(Packet packet, GenericFutureListener<? extends Future<? super Void>> genericfuturelistener, GenericFutureListener<? extends Future<? super Void>>... agenericfuturelistener) {
        if (this.g()) {
            ...
            try {
                this.i.add(new QueuedPacket(packet, (GenericFutureListener[]) ArrayUtils.add(agenericfuturelistener, 0, genericfuturelistener)));
            } finally {
                this.j.writeLock().unlock();
            }
        }
        ...
        if (this.channel != null && this.channel.isOpen()) {
            ...
            try {
                while (!this.i.isEmpty()) {
                    QueuedPacket networkmanager_queuedpacket = (QueuedPacket) this.i.poll();
