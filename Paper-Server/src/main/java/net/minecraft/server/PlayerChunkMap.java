...
public class PlayerChunkMap {
    ...
    private final Queue<PlayerChunk> e = new java.util.concurrent.ConcurrentLinkedQueue<PlayerChunk>(); // CraftBukkit ArrayList -> ConcurrentLinkedQueue
    private final Queue<PlayerChunk> f = new java.util.concurrent.ConcurrentLinkedQueue<PlayerChunk>(); // CraftBukkit ArrayList -> ConcurrentLinkedQueue
    private int g;
    private long h;
    ...
    public void flush() {
        ...
        int j;
        PlayerChunk playerchunkmap_playerchunk;
