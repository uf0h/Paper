...
public class RegionFile {
    ...
    public DataOutputStream b(int i, int j) { // PAIL: getChunkOutputStream
        ...
        return this.d(i, j) ? null : new DataOutputStream(new java.io.BufferedOutputStream(new DeflaterOutputStream(new ChunkBuffer(i, j)))); // Spigot - use a BufferedOutputStream to greatly improve file write performance
    }
