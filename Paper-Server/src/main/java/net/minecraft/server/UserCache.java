    ...
    public void b() {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                UserCacheEntry usercache_usercacheentry = (UserCacheEntry) iterator.next();
            ...
            if (jsonelement.isJsonObject()) {
                ...
                if (jsonelement1 != null && jsonelement2 != null) {
                    ...
                    if (s1 != null && s != null) {
                        ...
                        UserCacheEntry usercache_usercacheentry = UserCache.this.new UserCacheEntry(new GameProfile(uuid, s1), date, null);
