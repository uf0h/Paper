...
public class CraftMetaItem implements ItemMeta, Repairable {
    ...
    public Collection<String> getModifiedAttributes() {
        return hasAttributeModifiers() ? ImmutableSet.copyOf(attributeModifiers.keySet()) : Collections.emptySet();
    }
    ...
    public Collection<AttributeModifier> getAttributeModifiers(String attribute) {
        return hasAttributeModifiers() ? attributeModifiers.get(attribute) : Collections.emptySet();
    }
